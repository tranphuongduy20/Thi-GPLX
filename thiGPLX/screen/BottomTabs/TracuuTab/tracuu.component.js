...
export const TracuuScreen = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <Layout style={{ flex: 1 }}>
        <View style={styles.hintStyle} activeOpacity={0.5}>
          <Image
        ...
        <Swiper style={{ borderWidth: 5, borderColor: "red" }}>
          ...
          >
            <Layout style={styles.meoContainer}>
              ...
              <Text style={styles.meoStyle}>
                - Câu hỏi có 2{" "}
                <Text style={{ fontWeight: "bold" }}>ĐÁP ÁN</Text>: Nếu câu hỏi
                có từ{" "}
                <Text style={{ fontWeight: "bold", fontSize: 17 }}>
                  “những”
                </Text>{" "}
                hoặc{" "}
                <Text style={{ fontWeight: "bold", fontSize: 17 }}>“các”</Text>,
                hãy chọn luôn cả 2 đáp án đó
              </Text>
              <Text style={styles.meoStyle}>
                - Câu hỏi có 3{" "}
                <Text style={{ fontWeight: "bold", fontSize: 17 }}>ĐÁP ÁN</Text>
                : 2 đáp án dài, 1 ngắn. Các bạn hãy đọc đáp án ngắn trước nếu
                đúng hãy chọn luôn đáp án đấy. Còn ngược lại chọn cả đáp án là
                cả 2.
              </Text>
            </Layout>
          </Layout>
          ...
          >
            <Layout style={styles.meoContainer}>
              ...
              <Text style={styles.meoStyle}>
                - Những câu hỏi liên quan đến khuân vác, vận chuyển chất gây
                hại, vật nặng: Chọn ngay{" "}
                <Text style={{ fontWeight: "bold", fontSize: 17 }}>
                  “bị nghiêm cấm”
                </Text>
                .
          ...
          >
            <Layout style={styles.meoContainer}>
              ...
              <Text style={styles.meoStyle}>
                ...
                chuyển hướng sang nơi giao nhau.
              </Text>
              <Text style={styles.meoStyle}>
                - Còn ngược lại nếu bạn gặp biển báo giao nhau với đường ưu
                tiên, bắt buộc phải chờ cho xe trên đường ưu tiên đi trước.
              </Text>
              <Text style={styles.meoStyle}>
                - Còn các biển báo khác yêu cầu mỗi học viên phải học nhận dạng
                và trải nghiệm nên các bạn phải xem hình thật kỹ.
              </Text>
            </Layout>
          </Layout>
          <Layout
          ...
          >
            <Layout style={styles.meoContainer}>
              ...
              <Text style={styles.meoStyle}>
                <Text style={{ fontWeight: "bold" }}> XE CON LUÔN ĐÚNG</Text>:
                Tức là xe con là từ khóa, xe con luôn chấp hành đúng quy tắc
                giao thông.
              </Text>
              <Text style={styles.meoStyle}>
                - Khi đề bài hỏi xe nào được quyền đi trước, xe nào chấp hành
                đúng luật giao thông {"=>"} Chọn đáp án có xe con.
              </Text>
              <Text style={styles.meoStyle}>
                - Khi đề bài hỏi xe nào vi phạm quy tắc giao thông {"=>"} Chọn
                đáp án không có xe con (Vì xe con luôn đúng).
              </Text>
              <Text style={styles.meoStyle}>
                <Text style={{ fontWeight: "bold" }}>
                  {" "}
